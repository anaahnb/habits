<div id="modalEditarPerfil" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-gray-700 rounded-lg shadow">
            ...
            <form action="" method="POST" class="flex flex-col gap-4 items-stretch w-full max-w-md mt-10">
                <div class="p-6 space-y-6">
                    <label for="nome" class="flex flex-col gap-3 text-gray-100 font-sans">
                        Nome
                        <input value="{{$user->name}}" class="flex items-center gap-3 h-12 py-4 px-3 rounded bg-gray-600 w-full focus-within:ring-2 ring-cyan-300 placeholder:text-gray-400" type="text">
                    </label>
    
                    <label for="email" class="flex flex-col gap-3 text-gray-100 font-sans">
                        Endereço de e-mail
                        <input value="{{$user->email}}" class="flex items-center gap-3 h-12 py-4 px-3 rounded bg-gray-600 w-full focus-within:ring-2 ring-cyan-300 placeholder:text-gray-400" type="text">
                    </label>
                    ...
                    <div class="flex gap-3">
                        <a href="" class="flex gap-3 border border-green-400 text-gray-200 items-center justify-center mt-12 py-3 px-4 rounded font-semibold text-sm w-full transition-colors">
