        ...
        <div class="relative bg-gray-700 rounded-lg shadow">
            ...
            <form action="" class="flex flex-col gap-4 items-stretch w-full max-w-sm mt-10">
                ...
                <div class="flex gap-3">
                    <a class="flex gap-3 border border-green-400 items-center justify-center mt-12 py-3 px-4 rounded font-semibold text-sm w-full transition-colors">
                    ...
                    <a class="mt-12 py-3 px-4 bg-green-400 rounded font-semibold text-black text-sm w-full transition-colors hover:bg-emerald-400 focus:ring-2 ring-white">
                        Salvar alterações
                    </a>
                </div>
            </form>
