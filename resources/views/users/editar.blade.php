    ...
    <div class="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
        ...
        <form action="" class="flex flex-col gap-4 items-stretch w-full max-w-sm mt-10">
            <label for="nome" class="flex flex-col gap-3 text-gray-100 font-sans">
                Nome
                <input class="flex items-center gap-3 h-12 py-4 px-3 rounded bg-gray-600 w-full focus-within:ring-2 ring-cyan-300 placeholder:text-gray-400" type="text">
            </label>
            ...
            <label for="password" class="flex flex-col text-gray-100 font-sans">
                Senha
                <a class="text-sm text-gray-400 underline hover:text-gray-200" href="">Alterar sua senha</a>
            </label>

            <div class="flex gap-3">
                <button class="flex gap-3 border border-green-400 items-center justify-center mt-12 py-3 px-4 rounded font-semibold text-sm w-full transition-colors">
                ...
                <button class="mt-12 py-3 px-4 bg-green-400 rounded font-semibold text-black text-sm w-full transition-colors hover:bg-emerald-400 focus:ring-2 ring-white">Salvar alterações</button>
            </div>
