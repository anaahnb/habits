...
<div class="w-screen h-screen bg-gray-900 flex flex items-center justify-center">
    <header class="flex items-center gap-8">
        ...
        <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="text-white border-solid border-2 border-green-400 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center" type="button">
        ...
        <div id="dropdownDivider" class="w-56 z-10 hidden bg-gray-700 divide-y divide-gray-400 rounded-lg shadow w-44">
            ...
            <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownDividerButton">
                <li>
                    <a href="#" class="inline-flex px-4 py-2">
            ...
            <div class="py-2">
                <a href="{{ route('logout') }}" class="inline-flex items-center  px-4 py-2 text-sm text-gray-200">
