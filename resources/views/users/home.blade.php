    ...
    <header class="flex items-center gap-8">
        ...
        <div id="dropdownDivider" class="w-56 z-10 hidden bg-gray-700 divide-y divide-gray-400 rounded-lg shadow w-44">
            ...
            <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownDividerButton">
                ...
                <li>
                    <a href="{{route('objetivo.index')}}" class="cursor-pointer inline-flex px-4 py-2">
    ...
    <main class="w-96">
        <div class="flex flex-wrap gap-2">
            ...
            for ($i=1;$i<=30; $i++) {
                ...
                if($diario) {
                    print("
                    <button class='w-10 h-10 bg-green-400 rounded-lg' data-modal-target='modalVisualizarDiario' data-modal-toggle='modalVisualizarDiario'></button>
                    <div id='modalVisualizarDiario' tabindex='-1' aria-hidden='true' class='fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full'>
                        <div class='relative w-full max-w-sm max-h-full'>
                            <div class='relative bg-gray-700 rounded-lg shadow'>
                                <div class='flex items-start justify-between p-4 rounded-t'>
                                    ...
                                    <button type='button' class='text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white' data-modal-hide='modalVisualizarDiario'>
                    ...
                    print("<button class='w-10 h-10 bg-gray-800 border border-2 border-gray-700 rounded-lg' data-modal-target='modalVisualizarDiario' data-modal-toggle='modalVisualizarDiario'></button>");
                }
            }        
            ?>
        </div>
