            ...
            <ul>
                ...
                <li class="flex items-center justify-between gap-3 h-12 mb-2 py-4 px-4 rounded bg-gray-600 w-full focus-within:ring-2 ring-cyan-300 text-gray-200">
                    ...
                    <div class="flex gap-4">
                        <a data-modal-target="modalEditarObjetivo" data-modal-toggle="modalEditarObjetivo" title="Editar objetivo">
                        ...
                        <a title="Excluir objetivo" href="{{route("objetivo.destroy", $objetivo->objetivo_id)}}">
